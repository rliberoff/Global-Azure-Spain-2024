...
var serviceFlightsCatalog = builder.AddProject<Projects.GlobalAzureSpain_Demo_Services_FlightsCatalog>(@"flights-catalog")
    .WithEnvironment(@"ConnectionStrings:ApplicationInsights", appInsightsConnectionString)
    .WithDaprSidecar();

builder.AddProject<Projects.GlobalAzureSpain_Demo_Services_FunCatalog>(@"fun-catalog")
       .WithEnvironment(@"ConnectionStrings:ApplicationInsights", appInsightsConnectionString)
       .WithDaprSidecar();

var serviceHotelsCatalog = builder.AddProject<Projects.GlobalAzureSpain_Demo_Services_HotelsCatalog>(@"hotels-catalog")
    .WithEnvironment(@"ConnectionStrings:ApplicationInsights", appInsightsConnectionString)
    .WithDaprSidecar();

builder.AddProject<Projects.GlobalAzureSpain_Demo_Bot>(@"bot-backend")
       .WithEnvironment(@"ConnectionStrings:ApplicationInsights", appInsightsConnectionString)
...
builder.AddProject<Projects.GlobalAzureSpain_Demo_Services_VacationPlanner>(@"vacation-planner")
       .WithEnvironment(@"ConnectionStrings:ApplicationInsights", appInsightsConnectionString)
...
builder.AddNpmApp("bot-frontend", "../GlobalAzureSpain.Demo.WebChat", "start")
